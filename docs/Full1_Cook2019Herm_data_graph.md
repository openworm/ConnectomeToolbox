...
!!! abstract "Choose Graph type"
    ...
    <b><a href="../Full1_Cook2019Herm_data_graph"> Graph</a></b> - <a href="../Full1_Cook2019Herm_data"> Matrix</a> - <a href="../Full1_Cook2019Herm_data_hiveplot"> Hive plot</a> 
...
=== "Chemical"
    ...
    ```plotly
    { "file_path": "./assets/Cook2019Herm_Full1_Chemical_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/Cook2019Herm_Full1_Electrical_graph.json" }
    ```
