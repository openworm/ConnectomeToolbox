...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_L4_Social_Chemical_Exc.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_L4_Social_Electrical.json" }
    ```
