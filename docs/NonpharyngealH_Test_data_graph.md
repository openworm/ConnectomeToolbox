...
=== "Chemical Exc"
    ...
    { "file_path": "./assets/Test_NonpharyngealH_Chemical_Exc_graph.json" }
    ```

=== "Chemical Inh"

    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_Chemical_Inh_graph.json" }
    ```
