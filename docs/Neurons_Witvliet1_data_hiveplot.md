...
!!! tip "Choose View"
    ...
    <a href="../Witvliet1_data_hiveplot"> Raw Data</a> - <b><a href="../Neurons_Witvliet1_data_hiveplot"> Neurons</a></b> - <a href="../Pharynx_Witvliet1_data_hiveplot"> Pharynx</a> - <a href="../Social_Witvliet1_data_hiveplot"> Social Network</a> - <a href="../Escape_Witvliet1_data_hiveplot"> Escape Response Circuit</a> - <a href="../Full1_Witvliet1_data_hiveplot"> Cook 2019 Fig 3</a> - 

    <i>All 302 hermaphrodite neurons (whether present or not in the connectome dataset)</i>

!!! abstract "Choose Graph type"

    <a href="../Neurons_Witvliet1_data_graph"> Graph</a> - <a href="../Neurons_Witvliet1_data"> Matrix</a> - <b><a href="../Neurons_Witvliet1_data_hiveplot"> Hive plot</a></b> 
...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet1_Neurons_Chemical_Exc_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet1_Neurons_Electrical_hiveplot.json" }
    ```
