...
=== "Chemical Exc"
    ...
    { "file_path": "./assets/Test_NonpharyngealH_Chemical_Exc_symm.json" }
    ```
    Of 84100 possible edges, 11 are connected, 6 are mirrored - 54.55% 

=== "Chemical Inh"

    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_Chemical_Inh_symm.json" }
    ```
    Of 84100 possible edges, 3 are connected, 3 are mirrored - 100.00% 
...
=== "Electrical"
    ...
    ```
    Of 84100 possible edges, 4 are connected, 1 are mirrored - 25.00% 
...
=== "View info"
    ...
    **Nonpharyngeal Neurons (herm)** (NonpharyngealH)
    ...
    | --- | --- | --- |
    |**Chemical Exc** | (290, 290) matrix | 11 non-zero entries, sum of weights: 81|
    |**Chemical Inh** | (290, 290) matrix | 3 non-zero entries, sum of weights: 7|
    |**Electrical** | (290, 290) matrix | 5 non-zero entries, sum of weights: 14|
    |**Acetylcholine** | (290, 290) matrix | 11 non-zero entries, sum of weights: 81|
    |**GABA** | (290, 290) matrix | 3 non-zero entries, sum of weights: 7|
    
    
    | Nodes in view<br/>(290 total)| Num cells in node<br/>(290 total) |Num in this dataset<br/>(18 total) | Cells |
    | --- | --- | --- | --- |
