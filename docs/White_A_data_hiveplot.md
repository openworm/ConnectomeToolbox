...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_A_Raw_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_A_Raw_Electrical_hiveplot.json" }
    ```
