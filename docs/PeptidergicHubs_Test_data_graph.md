...
=== "Acetylcholine"
    ...
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_PeptidergicHubs_Acetylcholine_graph.json" }
    ```

=== "GABA"

    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_PeptidergicHubs_GABA_graph.json" }
    ```
