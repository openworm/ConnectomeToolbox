...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Test_Full1_Chemical_symm.json" }
    ```
    Of 289 possible edges, 4 are connected, 4 are mirrored - 100.00% 

=== "Electrical"

    <br/>
    ```plotly
    { "file_path": "./assets/Test_Full1_Electrical_symm.json" }
    ```
    Of 289 possible edges, 2 are connected, 2 are mirrored - 100.00% 
