...
=== "Chemical Exc"
    ...
    { "file_path": "./assets/Test_Raw_Chemical_Exc_hiveplot.json" }
    ```
...
=== "Chemical Inh"
    ...
    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_Raw_Chemical_Inh_hiveplot.json" }
    ```
