...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet7_Neurons_Chemical_Exc_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet7_Neurons_Electrical_hiveplot.json" }
    ```
