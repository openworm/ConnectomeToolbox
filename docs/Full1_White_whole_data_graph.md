...
!!! tip "Choose View"
    ...
    <a href="../White_whole_data_graph"> Raw Data</a><a href="../Neurons_White_whole_data_graph"> Neurons</a><a href="../Pharynx_White_whole_data_graph"> Pharynx</a><a href="../Social_White_whole_data_graph"> Social Network</a><a href="../Escape_White_whole_data_graph"> Escape Response Circuit</a><b><a href="../Full1_White_whole_data_graph"> Cook 2019 Fig 3</a></b>
...
=== "Electrical"
    ...
    ```plotly
    { "file_path": "./assets/White_whole_Full1_Electrical_graph.json" }
    ```
