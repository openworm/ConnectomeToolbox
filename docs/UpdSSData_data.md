...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/UpdSSData_Raw_Chemical.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/UpdSSData_Raw_Electrical.json" }
    ```
