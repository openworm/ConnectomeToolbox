...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/SSData_Pharynx_Chemical_Exc.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/SSData_Pharynx_Electrical.json" }
    ```
