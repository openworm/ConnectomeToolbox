...
=== "Chemical Exc"
    ...
    ```plotly
    { "file_path": "./assets/Cook2019Male_Neurons_Chemical_Exc_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/Cook2019Male_Neurons_Electrical_graph.json" }
    ```
