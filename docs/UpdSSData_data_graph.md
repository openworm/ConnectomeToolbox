...
=== "Chemical"
    ...
    ```plotly
    { "file_path": "./assets/UpdSSData_Raw_Chemical_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/UpdSSData_Raw_Electrical_graph.json" }
    ```
