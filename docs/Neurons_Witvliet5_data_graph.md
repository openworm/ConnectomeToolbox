...
=== "Chemical Exc"
    ...
    ```plotly
    { "file_path": "./assets/Witvliet5_Neurons_Chemical_Exc_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/Witvliet5_Neurons_Electrical_graph.json" }
    ```
