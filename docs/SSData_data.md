...
!!! tip "Choose View"
    ...
    <b><a href="../SSData_data"> Raw Data</a></b> - <a href="../Neurons_SSData_data"> Neurons</a> - <a href="../Pharynx_SSData_data"> Pharynx</a> - <a href="../Social_SSData_data"> Social Network</a> - <a href="../Escape_SSData_data"> Escape Response Circuit</a> - <a href="../Full1_SSData_data"> Cook 2019 Fig 3</a> - 

    <i>All of the cells present in the original connectome dataset</i>

!!! abstract "Choose Graph type"

    <a href="../SSData_data_graph"> Graph</a> - <b><a href="../SSData_data"> Matrix</a></b> - <a href="../SSData_data_hiveplot"> Hive plot</a> 
...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/SSData_Raw_Chemical.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/SSData_Raw_Electrical.json" }
    ```
