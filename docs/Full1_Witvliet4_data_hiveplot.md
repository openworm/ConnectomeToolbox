...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet4_Full1_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet4_Full1_Electrical_hiveplot.json" }
    ```
