...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Social_Chemical_Exc.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Social_Electrical.json" }
    ```
