...
!!! tip "Choose View"
    ...
    <a href="../Witvliet8_data_hiveplot"> Raw Data</a><a href="../Neurons_Witvliet8_data_hiveplot"> Neurons</a><a href="../Pharynx_Witvliet8_data_hiveplot"> Pharynx</a><a href="../Social_Witvliet8_data_hiveplot"> Social Network</a><a href="../Escape_Witvliet8_data_hiveplot"> Escape Response Circuit</a><b><a href="../Full1_Witvliet8_data_hiveplot"> Cook 2019 Fig 3</a></b>

    <i>A view of the data set with neurons grouped as in Figure 3 of Cook et al. 2019</i>

!!! abstract "Choose Graph type"

    <a href="../Full1_Witvliet8_data_graph"> Graph</a> - <a href="../Full1_Witvliet8_data"> Matrix</a> - <b><a href="../Full1_Witvliet8_data_hiveplot"> Hive plot</a></b> 
...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet8_Full1_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet8_Full1_Electrical_hiveplot.json" }
    ```
