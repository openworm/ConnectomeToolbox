...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Test_PeptidergicHubs_Chemical_Exc_symm.json" }
    ```
    Of 16 possible edges, 4 are connected, 4 are mirrored - 100.00% 

=== "Chemical Inh"

    <br/>
    ```plotly
    { "file_path": "./assets/Test_PeptidergicHubs_Chemical_Inh_symm.json" }
    ```
    Of 16 possible edges, 2 are connected, 2 are mirrored - 100.00% 

=== "Electrical"

    <br/>
    ```plotly
    { "file_path": "./assets/Test_PeptidergicHubs_Electrical_symm.json" }
    ```
    Of 16 possible edges, 2 are connected, 2 are mirrored - 100.00% 
