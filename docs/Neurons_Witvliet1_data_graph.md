...
=== "Chemical Exc"
    ...
    ```plotly
    { "file_path": "./assets/Witvliet1_Neurons_Chemical_Exc_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/Witvliet1_Neurons_Electrical_graph.json" }
    ```
