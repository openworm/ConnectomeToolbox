...
=== "Chemical Exc"
    ...
    ```plotly
    { "file_path": "./assets/UpdSSData_Pharynx_Chemical_Exc_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/UpdSSData_Pharynx_Electrical_graph.json" }
    ```
