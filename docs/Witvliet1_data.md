...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet1_Raw_Chemical.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet1_Raw_Electrical.json" }
    ```
