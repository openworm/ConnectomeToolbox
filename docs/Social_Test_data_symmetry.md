...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Test_Social_Chemical_Exc_symm.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Test_Social_Electrical_symm.json" }
    ```
    Of 64 possible edges, 1 are connected, 1 are mirrored - 100.00% 
