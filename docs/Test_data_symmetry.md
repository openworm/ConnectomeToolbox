...
=== "Chemical"
    ...
    ```
    Of 324 possible edges, 15 are connected, 3 are mirrored - 20.00% 
...
=== "Electrical"
    ...
    ```
    Of 324 possible edges, 3 are connected, -3 are mirrored - -100.00% 
