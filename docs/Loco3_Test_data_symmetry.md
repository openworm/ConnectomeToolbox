...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Test_Loco3_Chemical_Exc_symm.json" }
    ```
    Of 3600 possible edges, 4 are connected, 4 are mirrored - 100.00% 

=== "Chemical Inh"

    <br/>
    ```plotly
    { "file_path": "./assets/Test_Loco3_Chemical_Inh_symm.json" }
    ```
    Of 3600 possible edges, 3 are connected, 3 are mirrored - 100.00% 

=== "Electrical"

    <br/>
    ```plotly
    { "file_path": "./assets/Test_Loco3_Electrical_symm.json" }
    ```
    Of 3600 possible edges, 2 are connected, 2 are mirrored - 100.00% 
