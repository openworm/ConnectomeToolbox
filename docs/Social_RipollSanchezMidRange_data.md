...
!!! abstract "Choose Graph type"
    ...
    <a href="../Social_RipollSanchezMidRange_data_graph"> Graph</a> - <b><a href="../Social_RipollSanchezMidRange_data"> Matrix</a></b> - <a href="../Social_RipollSanchezMidRange_data_hiveplot"> Hive plot</a> 
...
=== "Extrasynaptic"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/RipollSanchezMidRange_Social_Extrasynaptic.json" }
    ```
