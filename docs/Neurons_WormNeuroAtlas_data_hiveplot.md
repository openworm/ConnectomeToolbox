...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Neurons_Chemical_Exc_hiveplot.json" }
    ```
...
=== "Chemical Inh"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Neurons_Chemical_Inh_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Neurons_Electrical_hiveplot.json" }
    ```
