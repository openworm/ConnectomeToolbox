...
=== "Chemical Exc"
    ...
    ```plotly
    { "file_path": "./assets/Witvliet7_Social_Chemical_Exc_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/Witvliet7_Social_Electrical_graph.json" }
    ```
