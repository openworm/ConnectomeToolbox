...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_whole_Full1_Chemical.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_whole_Full1_Electrical.json" }
    ```
