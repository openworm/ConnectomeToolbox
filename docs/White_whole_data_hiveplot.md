...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_whole_Raw_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_whole_Raw_Electrical_hiveplot.json" }
    ```
