...
=== "Chemical"
    ...
    ```plotly
    { "file_path": "./assets/White_L4_Full1_Chemical_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/White_L4_Full1_Electrical_graph.json" }
    ```
