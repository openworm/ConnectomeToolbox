...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Pharynx_Chemical_Exc_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Pharynx_Electrical_hiveplot.json" }
    ```
