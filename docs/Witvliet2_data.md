...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet2_Raw_Chemical.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet2_Raw_Electrical.json" }
    ```
