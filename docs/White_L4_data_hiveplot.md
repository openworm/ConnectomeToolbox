...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_L4_Raw_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_L4_Raw_Electrical_hiveplot.json" }
    ```
