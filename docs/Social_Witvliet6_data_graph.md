...
=== "Chemical Exc"
    ...
    ```plotly
    { "file_path": "./assets/Witvliet6_Social_Chemical_Exc_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/Witvliet6_Social_Electrical_graph.json" }
    ```
