...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_L4_Raw_Chemical.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_L4_Raw_Electrical.json" }
    ```
