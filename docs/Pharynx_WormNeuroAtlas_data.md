...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Pharynx_Chemical_Exc.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/WormNeuroAtlas_Pharynx_Electrical.json" }
    ```
