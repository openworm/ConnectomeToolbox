...
=== "Chemical"
    ...
    ```plotly
    { "file_path": "./assets/White_A_Raw_Chemical_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/White_A_Raw_Electrical_graph.json" }
    ```
