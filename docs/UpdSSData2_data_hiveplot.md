...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/UpdSSData2_Raw_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/UpdSSData2_Raw_Electrical_hiveplot.json" }
    ```
