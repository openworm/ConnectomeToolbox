...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Cook2020_Raw_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Cook2020_Raw_Electrical_hiveplot.json" }
    ```
