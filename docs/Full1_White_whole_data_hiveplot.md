...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_whole_Full1_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_whole_Full1_Electrical_hiveplot.json" }
    ```
