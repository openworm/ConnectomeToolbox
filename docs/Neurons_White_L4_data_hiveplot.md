...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_L4_Neurons_Chemical_Exc_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/White_L4_Neurons_Electrical_hiveplot.json" }
    ```
