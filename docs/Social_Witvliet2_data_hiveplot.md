...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet2_Social_Chemical_Exc_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet2_Social_Electrical_hiveplot.json" }
    ```
