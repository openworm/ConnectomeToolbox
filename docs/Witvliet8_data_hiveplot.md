...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet8_Raw_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Witvliet8_Raw_Electrical_hiveplot.json" }
    ```
