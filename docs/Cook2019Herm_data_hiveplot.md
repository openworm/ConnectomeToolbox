...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Cook2019Herm_Raw_Chemical_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Cook2019Herm_Raw_Electrical_hiveplot.json" }
    ```
