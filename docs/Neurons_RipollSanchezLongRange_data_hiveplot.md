...
!!! abstract "Choose Graph type"
    ...
    <a href="../Neurons_RipollSanchezLongRange_data_graph"> Graph</a> - <a href="../Neurons_RipollSanchezLongRange_data"> Matrix</a> - <b><a href="../Neurons_RipollSanchezLongRange_data_hiveplot"> Hive plot</a></b> 
...
=== "Extrasynaptic"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/RipollSanchezLongRange_Neurons_Extrasynaptic_hiveplot.json" }
    ```
