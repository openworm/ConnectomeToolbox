...
=== "Chemical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Cook2019Herm_Full1_Chemical.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Cook2019Herm_Full1_Electrical.json" }
    ```
