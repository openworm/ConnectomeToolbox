...
=== "View info"
    ...
    **Locomotion 2** (Loco2)
    ...
    | Nodes in current view<br/>(9 total) <span style="color:#ffffff;">xxxxxxxxxxxxxxxxxxxxxxxxx</span>| Num cells in node<br/>(144 total) | Num in this dataset<br/>(9 total) | Cells in node |
    | --- | --- | --- | --- |
