...
=== "Chemical"
    ...
    ```plotly
    { "file_path": "./assets/Cook2019Male_Full1_Chemical_graph.json" }
    ```

=== "Electrical"

    ```plotly
    { "file_path": "./assets/Cook2019Male_Full1_Electrical_graph.json" }
    ```
